...
public:
    ...
    [[nodiscard]] Hash finalize(bool use_v2_2);
...
[[nodiscard]] inline Hash verus_hash(std::span<const uint8_t> s, bool use_v2_2)
{
    return Verus::VerusHasher().write(s).finalize(use_v2_2);
}
